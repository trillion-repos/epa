...
* The users can click on each state for 1 year, 3 year, 5 year and 10 year  of the map to obtain a bar graph of annual historical color coded Lead information, for each of the categories per US state.
